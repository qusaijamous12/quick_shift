...
class _MyJobScreenState extends State<MyJobScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero,()async{
      await _loginController.getMyJobs();
    });
    super.initState();
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if(_loginController.allMyJobs.isNotEmpty)...[
                Expanded(
                  child: ListView.separated(

                      itemBuilder: (context,index)=>buildMyJob(_loginController.allMyJobs[index]),
                      separatorBuilder: (context,index)=>const SizedBox(height: PaddingManger.kPadding/2,),
                      itemCount: _loginController.allMyJobs.length),
                )
              ]else...[
                Expanded(
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'There is No Jobs For Your Company !',
